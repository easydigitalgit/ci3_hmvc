<div class="card">
    <div class="card-header">
        <div class="card-title">
            <h4> Tabel Data Pendaftaran Ulang </h4>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <div class="py-2">
                <?php echo isset($headDaftarUlang) ? $headDaftarUlang : ''; ?>

            </div>
            <table width="100%" class="table table-hover" id="table_daftar_ulang" data-source="table_daftar_ulang">
                <thead>
                    <tr>
                        ...
                        <th width="">Status Pendaftaran</th>
