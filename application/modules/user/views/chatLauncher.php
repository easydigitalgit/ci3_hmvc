        ...
        <div class="body">
            ...
            <ul class="chat-scroll-list clearfix">
                <li class="left float-left">
                    <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar3.jpg');?>" class="rounded-circle" alt="">
                    <div class="chat-info">
                ...
                <li class="left float-left"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar2.jpg');?>" class="rounded-circle" alt="">
                ...
                <li class="left float-left"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar1.jpg');?>" class="rounded-circle" alt="">
