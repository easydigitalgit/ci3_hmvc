                    ...
                    <div class="body">
                            <div class="row">
                                <div class="col-sm-4 col-4 m-b-10">
                                    ...
                                    <h5 class="m-b-0">1,256 <small class="text-muted"><i class="zmdi zmdi-caret-up text-success"></i> 18%</small></h5>
                                </div>
                                <div class="col-sm-4 col-4 m-b-10">
                                    <span class="text-muted">Lifestyle</span>
                                    <h5 class="m-b-0">621 <small class="text-muted"><i class="zmdi zmdi-caret-down text-danger"></i> 8%</small></h5>                                    
                                </div>
                                <div class="col-sm-4 col-4 m-b-10">
                                    <span class="text-muted">Sports</span>
                                    <h5 class="m-b-0">981 <small class="text-muted"><i class="zmdi zmdi-caret-up text-success"></i> 5%</small></h5>                                    
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="table-responsive">
                            <table class="table m-b-0 m-t-15">
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Chrome</td>
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div id="world-map-markers" class="jvector-map m-b-25"></div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="table-responsive">                                    
                       ...
                       <ul class="inbox-widget list-unstyled clearfix">
                           <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar3.jpg');?>" alt=""> </div>
                           ...
                           <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar2.jpg');?>" alt=""> </div>
                                   <div class="inbox-item-info">
                           ...
                           <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar4.jpg');?>" alt=""> </div>
                                   <div class="inbox-item-info">
                           ...
                           <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar5.jpg');?>" alt=""> </div>
                                   <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"><a href="javascript:void(0);">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="<?php echo base_url('vendor/plugin/theme/nexa/images/xs/avatar1.jpg');?>" alt=""> </div>
                                   <div class="inbox-item-info">
