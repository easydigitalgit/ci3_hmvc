<div class="card">
	<div class="card-header">
		<div class="card-title"> 
			<h4> Tabel Daftar Tahun Pelajaran </h4>
	...
	<div class="card-body">
		<div class="table-responsive">
			<div class="py-2"> 
		      <?php echo isset($head_tahun_pelajaran) ? $head_tahun_pelajaran : ''; ?>
		              
		    </div>
			<table width="100%" class="table table-hover" id="table_tahun_pelajaran" data-source="table_tahun_pelajaran">
                <thead>
                    <tr>
