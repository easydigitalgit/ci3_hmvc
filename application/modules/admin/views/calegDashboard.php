 ...
 <div class="row">
     <div class="col-xl-4">
         <div class="card h-100 overflow-hidden">
             ...
             <div class="card-body ">
                 <div class="">
                    <h4 class="alert alert-info mt-2 p-2"> Tabel Capaian Koord. Relawan </h4>
                    <div class="">
                       
                        <table width="100%" class="table table-hover" id="table_relawan_rank" data-source="table_relawan_rank">
                            <thead>
                                <tr>
                                   
                                    <th width="5%">#</th>
                                    <th width="10%">Admin Entry</th>
                                    <th width="10%">Nama Koord. Relawan</th>
     ...
     <div class="col-xl-8">
         ...
         <div class="card h-100 ">
             <div class="card-body">
                 ...
                 <div class="">
                     <h4 class="card-title mb-2">#TOP-10 Capaian Koord. Relawan</h4> <span> Per tanggal:  <span id="lastUpdate"> 00-00-0000 </span> </span>
