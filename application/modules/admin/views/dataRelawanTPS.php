<div class="card">
    <div class="card-header">
        <div class="card-title">
            <h4> Tabel Data Anggota Per TPS</h4>
    ...
    <div class="card-body">
                ...
                <div class="card-title">
                    <div class="col">
                        ...
                        <div class="float-right">
                            <button type="button" class="btn btn-sm btn-success exportExcel"><i class="mdi  mdi-file-excel"> </i> Export Excel</button>

                            <span class="btn btn-sm btn-primary" data-bs-toggle="collapse" href="#collapseFilter" aria-expanded="true" aria-controls="collapseFilter">Filter Data Anggota</span>
                                ...
                                <div class="card-body collapse" id="collapseFilter">
                                    <form action="#" method="post" id="form_filter_table" name="form_filter_table" enctype="multipart/form-data" accept-charset="utf-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-0 ">
                                                    <label for="filter_terdaftar" class="col-md-6 col-form-label">Pemilih Terdaftar</label>
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="filter_terdaftar" id="filter_terdaftar">
                                                            <option value="">--</option>
        ...
        <div class="table-responsive">
            <div class="py-2">
                ...
                <table width="100%" class="table table-hover" name="table_data_relawan_tps" id="table_data_relawan_tps" data-source="table_data_relawan_tps">
                    <thead>
                        <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-primary ">
                        <h5> Update Nomor TPS Anggota </h5>
                        <small class="text-danger">*perubahan yang disimpan hanya Nomor TPS, data lain yang diubah pada form ini akan diabaikan</small>
                    </div>
