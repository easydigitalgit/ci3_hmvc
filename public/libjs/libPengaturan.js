...
$('.selectJenisTes').load(currentClass+'/select_jenis_tes');
...
function action_btn(){
    ...
    $.ajax({
        ...
        success: function(resp)
        {
            if (resp.status) {
                ...
                setJenjangKelas(resp.data['unit_sekolah_id'],resp.data['jenjang_kelas_id']);
    ...
    function setJenjangKelas(tingkatID, jenjangID){

       $(".selectJenjangKelas").load(currentClass+'/select_jenjang_kelas/'+tingkatID, function(){
                //console.log('load Jenjang kelas');
                $("#jenjang_kelas_id ").val(jenjangID);
            });
