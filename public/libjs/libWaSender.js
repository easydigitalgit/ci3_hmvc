...
var save_method;
var urlSave  = ''; 
var tbLWaTemplate = $('#table_wa_template')



$(document).ready(function() {
   
    loadDataTable(tbLWaTemplate);
...
$('.AddBtn').click(function(){
    ...
    console.log('ADD '+dataLabel);
	    ...
	    $('.help-block').empty();
	    $('.modal-title').text('Tambah data template');
