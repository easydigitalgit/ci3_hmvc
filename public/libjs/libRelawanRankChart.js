$(document).ready(function() {
 ...
 chartRelawanRank = new Chart(document.getElementById("chart"), {
            type: 'bar',
            data: {
         ...
         ajax_RelawanRankChart(chartRelawanRank);
 ...
 function ajax_RelawanRankChart(chart, data) {
           let url = currentClass+'/chart_relawan_rank' ;
