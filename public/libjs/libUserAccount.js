...
var save_method='';
var urlSave     = ''; 
var tbAkunUser 		   = $('#table_data_akun_pengguna');
var tbKategoriWarning     = $('#table_data_kategori_peringatan');
var tbUserGrup = $('#table_data_grup_pengguna');


$(document).ready(function() {
    loadDataTable(tbAkunUser);
    loadDataTable(tbKategoriWarning);
    loadDataTable(tbUserGrup);
    $("#check-all").click(function () {
        $(".data-check").prop('checked', $(this).prop('checked'));
    });
    $("#prop_id").load(site_url+class_url+'/selectPropinsi');
